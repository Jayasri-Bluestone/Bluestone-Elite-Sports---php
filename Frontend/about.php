    ...
    <div class="container mx-auto px-4 md:px-12 grid md:grid-cols-2 gap-12 md:gap-16 items-center relative z-10 pt-24 pb-12 md:py-20">
        ...
        <div class="relative group order-2 md:order-1">
            ...
            <div class="relative aspect-[4/3] rounded-[3rem] overflow-hidden border border-white/20 shadow-2xl">
                <img src="assets/md gallery6.png" alt="Elite Academy Action" class="w-full h-full object-cover">
                <div class="absolute inset-0 bg-black/20"></div>
            </div>
            <!-- Floating Badge -->
            <div class="absolute -bottom-6 -right-6 bg-white p-6 rounded-3xl shadow-2xl hidden lg:block">
                <div class="text-secondary font-black text-4xl italic tracking-tighter uppercase">10+</div>
                <div class="text-slate-400 text-[10px] font-black uppercase tracking-widest italic">Years Elite</div>
            </div>
        </div>

        <!-- Text Right Side -->
        <div class="text-white order-1 md:order-2">
            <div class="inline-block bg-black/10 text-black border border-black/20 px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest mb-6 italic">Established 2012</div>
            <h1 class="text-3xl md:text-8xl font-black uppercase italic tracking-tighter leading-[0.9] mb-8">
                Our <span class="text-black block italic">Legacy</span>
            </h1>
            <p class="text-black/90 text-lg md:text-xl font-bold tracking-wide leading-relaxed italic">
                Fueling the next generation of <span class="text-white uppercase italic">international sports icons</span> through precision and passion.
            </p>
        </div>
    </div>
</section>
...
<section class="py-24 container mx-auto px-4 md:px-12">
    <div class="grid md:grid-cols-2 gap-20 items-center">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="aspect-square bg-slate-900 rounded-3xl overflow-hidden shadow-2xl mt-12 border-4 border-white">
                <img src="assets/md gallery1.png" class="w-full h-full object-cover opacity-80 hover:opacity-100 transition duration-500">
            </div>
            <div class="aspect-square bg-slate-900 rounded-3xl overflow-hidden shadow-2xl border-4 border-primary">
                <img src="assets/md gallery2.png" class="w-full h-full object-cover opacity-80 hover:opacity-100 transition duration-500">
            </div>
        </div>
    </div>
</section>
...
<section class="py-24 bg-slate-900 text-white relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 md:px-12 relative z-10 text-center">
        <!-- Tagline Badge -->
        <div class="inline-block bg-primary text-white px-10 py-4 rounded-full text-2xl font-black uppercase italic tracking-tighter mb-12 shadow-2xl shadow-primary/20">
            Train Hard. Play Smart. Rise Elite
        </div>

        <p class="max-w-4xl mx-auto text-lg md:text-xl font-bold leading-relaxed text-slate-300 italic mb-16">
        ...
        <div class="flex flex-row items-center justify-center gap-2 md:gap-4 mb-20 translate-y-10 group">
            ...
            <div class="w-40 h-40 md:w-80 md:h-80 rounded-full border-[8px] md:border-[12px] border-white overflow-hidden shadow-2xl z-20 scale-110 hover:scale-[1.15] transition duration-500 shrink-0">
                <img src="assets/BGI Brochure Final-12.png" class="w-full h-full object-cover">
            </div>
            <div class="w-32 h-32 md:w-64 md:h-64 rounded-full border-[6px] md:border-[10px] border-primary overflow-hidden shadow-2xl transform md:translate-x-8 hover:scale-105 transition duration-500 shrink-0">
        ...
        <div class="mt-24 max-w-2xl mx-auto">
            <div class="bg-white/5 backdrop-blur-md p-8 rounded-3xl border border-white/10 mb-8">
                <p class="text-xl md:text-2xl font-black uppercase tracking-tighter leading-none italic">
                    Transforming passion into performance and <span class="text-primary">potential into podium success!!</span>
                </p>
            </div>
            <div class="inline-flex items-center gap-4 bg-slate-800 px-8 py-3 rounded-2xl border border-slate-700">
                <span class="text-xs font-bold uppercase tracking-widest text-slate-400">Contact Elite</span>
                <span class="text-xl font-black text-white italic tracking-tighter">87788 39909</span>
            </div>
        </div>
    </div>
</section>
